...
public class Scratch extends Sprite {
	...
	public var checkIfSaveNeeded:Boolean = true;
	...
	protected function setupExternalInterface(oldWebsitePlayer:Boolean):void {
		...
		addExternalCallback('ASsetLanguage', Translator.setLanguage );
	...
	private function uncaughtErrorHandler(event:UncaughtErrorEvent):void {
		...
		if(errorMessage != ""){
			externalCall("editor.logFlashError", null, errorMessage);
		}
	}
	...
	public function logException(e:Error):void {
		log(LogLevel.ERROR, e.toString() + e.getStackTrace() );
	}
	...
	public function setPresentationMode(enterPresentation:Boolean):void {
		...
		jsFullscreenHide( enterPresentation );
...
//		}
	...
	protected function takeScriptsScreenshot():void{

		function scriptImageSaved(e:Event):void{ 
			var loader:URLLoader = URLLoader(e.target);
			var data:Object = util.JSON.parse(loader.data);
	...
	public function jsFullscreenPosition( _x:int ):void{
		externalCall('editor.setFullscreenPosition', null, _x );
	}
	public function jsFullscreenOverlay( _b:Boolean ):void{
		externalCall('editor.toggleFullscreenOverlay', null, _b );
	}
	public function jsFullscreenHide( _b:Boolean ):void{
		externalCall('editor.toggleFullscreenDisplay', null, _b );
	}
	...
	public function jsLanguageChanged( name:String ):void {
		externalCall('editor.languageChanged', null, name );
	}
